  ...
  (self["webpackChunkdemoApp"] = self["webpackChunkdemoApp"] || []).push([["src_app_edit-family-details_edit-family-details_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EditFamilyDetailsPageRoutingModule": function EditFamilyDetailsPageRoutingModule() {
          return (
            /* binding */
            _EditFamilyDetailsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _edit_family_details_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./edit-family-details.page */
      67232);
      ...
      var _EditFamilyDetailsPageRoutingModule = function EditFamilyDetailsPageRoutingModule() {
        _classCallCheck(this, EditFamilyDetailsPageRoutingModule);
      };

      _EditFamilyDetailsPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EditFamilyDetailsPageModule": function EditFamilyDetailsPageModule() {
          return (
            /* binding */
            _EditFamilyDetailsPageModule
          );
        }
        /* harmony export */
      ...
      var _edit_family_details_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./edit-family-details-routing.module */
      81059);
      /* harmony import */


      var _edit_family_details_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./edit-family-details.page */
      67232);

      var _EditFamilyDetailsPageModule = function EditFamilyDetailsPageModule() {
        _classCallCheck(this, EditFamilyDetailsPageModule);
      };

      _EditFamilyDetailsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _edit_family_details_routing_module__WEBPACK_IMPORTED_MODULE_0__.EditFamilyDetailsPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EditFamilyDetailsPage": function EditFamilyDetailsPage() {
          return (
            /* binding */
            _EditFamilyDetailsPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_edit_family_details_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./edit-family-details.page.html */
      10838);
      /* harmony import */


      var _edit_family_details_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./edit-family-details.page.scss */
      46094);
      /* harmony import */
      ...
      71155); // import { ApiService } from 'src/src/app/services/api.service';


      var _EditFamilyDetailsPage = /*#__PURE__*/function () {
        function EditFamilyDetailsPage(languageService, apiService, fb) {
          _classCallCheck(this, EditFamilyDetailsPage);
        ...
        _createClass(EditFamilyDetailsPage, [{
          key: "ngOnInit",
          ...
          value: function getFamily() {
            ...
            this.apiService.getFamilyDetailsById(localStorage.getItem('userId')).subscribe(function (res) {
              console.log(res); // this.childDataValue.p
              // res.data.CHILD_DETAIL.forEach((data: any) => {
              //   this.childDataValue.push(data);
              // })
              // this.familyData = res.data;
              // this.form.value.CHILD_DETAIL = res.data.CHILD_DETAIL
              // this.familyData.CHILD_DETAIL.forEach((data: any) => {
              //   this.allChildValue.push(data);
              // })

              console.log(_this.childDataValue);
              console.log(_this.childDataValue);
            }, function (err) {
              console.log(err);
            });
          ...
          key: "getChildName",
          value: function getChildName(childName) {
          ...
          key: "getChildAge",
          value: function getChildAge(chidAge) {
            console.log(chidAge);
            this.allChildAge = [];
            this.allChildAge.push(chidAge); // this.childDataValue.value.forEach((data: any) => {
          ...
          value: function onSubmit() {
            ...
            this.allChildName.forEach(function (data) {
              _this2.finalValue.push(data);
            });
            this.allChildAge.forEach(function (data) {
              _this2.finalValue.push(data);
            });
            console.log(this.finalValue);
            console.log(this.familyFrom.value); // console.log(this.allChildValue);
        ...
        return EditFamilyDetailsPage;
      }();

      _EditFamilyDetailsPage.ctorParameters = function () {
        return [{
      ...
      _EditFamilyDetailsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
...
//# sourceMappingURL=src_app_edit-family-details_edit-family-details_module_ts-es5.js.map