    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _LoginPage = /*#__PURE__*/function () {
        ...
        _createClass(LoginPage, [{
          ...
          key: "getCheckedValue",
          value: function getCheckedValue(checkValue) {
          ...
          value: function onSubmit() {
            ...
            console.log(this.form.value.REFERAL_CODE); // this.form.value.REFERAL_CODE = "pvSJxrR8";

            console.log(this.showTextBox);

            if (this.showTextBox) {
              console.log('under if');
              this.apiService.verifyRefferalCode(this.form.value.REFERAL_CODE).subscribe(function (res) {
                if (res.status === 200) {
                  localStorage.setItem('refferalCode', _this2.form.value.REFERAL_CODE);

                  _this2.getOtpOfUsers();
                } else {}
              }, function (err) {
                console.log(err);
