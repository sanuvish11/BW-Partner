        ...
        _createClass(EditFamilyDetailsPage, [{
          ...
          value: function getFamily() {
            ...
            this.apiService.getFamilyDetailsById(localStorage.getItem('userId')).subscribe(function (res) {
              console.log(res); // this.familyData = res.data;
              // console.log(this.familyData)

              res.data.CHILD_DETAIL.forEach(function (data) {
                _this.familyFrom.get("childValue").push(data);
              });
              console.log(_this.familyFrom);
            }, function (err) {
              console.log(err);
            });
          }
